...
methods: {
	...
	deleteCarProd: function (index) {	
  	...
  	addProducto: function () {
  		...
  		axios.post('http://localhost/Vuejs/SerafinaVue/api/v1.php?action=create', formData)
  		.then(function (response) {
  	...
  	updateProducto: function () {
  		...
  		axios.post('http://localhost/Vuejs/SerafinaVue/api/v1.php?action=update', formData)
  		.then(function (response) {
  			app.clickedProd = {};
  			if (response.data.error) {
  				app.errorMessage = response.data.message;
  	...
  	deleteProducto: function () {
  		var formData = app.toFormData(app.clickedProd);
  		axios.post('http://localhost/Vuejs/SerafinaVue/api/v1.php?action=delete', formData)
  		.then(function (response) {
  			app.clickedProd = {};
  			if (response.data.error) {
  				app.errorMessage = response.data.message;
	...
	getAllCategorias: function () {
		axios.get('http://localhost/Vuejs/SerafinaVue/api/v1.php?action=readcat')
		.then(function (response) {
			if (response.data.error) {
				app.errorMessage = response.data.message;
			} else {
